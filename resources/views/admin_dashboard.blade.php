...
<html lang="en">
  <head>
    ...
    <!-- Plugins css -->
    <link
      href="{{ asset('backend/assets/libs/flatpickr/flatpickr.min.css')}}"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="{{ asset('backend/assets/libs/selectize/css/selectize.bootstrap3.css')}}"
      rel="stylesheet"
      type="text/css"
    />
            ...
            <div class="p-2">
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-10.jpg')}}"
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-9.jpg')}}"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
            ...
            <div class="p-2 pb-4">
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-4.jpg')}}"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
                    <i class="mdi mdi-circle user-status away"></i>
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-6.jpg')}}"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
                    <i class="mdi mdi-circle user-status online"></i>
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-7.jpg')}}"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
                    <i class="mdi mdi-circle user-status busy"></i>
              ...
              >
                <div class="d-flex align-items-start noti-user-item">
                  <div class="position-relative me-2">
                    <img
                      src="{{ asset('backend/assets/images/users/user-8.jpg')}}"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
                    <i class="mdi mdi-circle user-status away"></i>

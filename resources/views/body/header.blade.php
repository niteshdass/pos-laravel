        ...
        <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
            ...
            <div class="p-lg-1">
                ...
                <div class="col">
                    <a class="dropdown-icon-item" href="#">
                    <img
                        src="{{ asset('backend/assets/images/brands/github.png')}}"
                        alt="Github"
                    />
                    <span>GitHub</span>
                    </a>
                ...
                <div class="col">
                    <a class="dropdown-icon-item" href="#">
                    <img
                        src="{{ asset('backend/assets/images/brands/dribbble.png')}}"
                        alt="dribbble"
                    />
                    <span>Dribbble</span>
                    </a>
                ...
                <div class="col">
                    <a class="dropdown-icon-item" href="#">
                    <img
                        src="{{ asset('backend/assets/images/brands/bitbucket.png')}}"
                        alt="bitbucket"
                    />
                    <span>Bitbucket</span>
                    </a>
                ...
                <div class="col">
                    <a class="dropdown-icon-item" href="#">
                    <img
                        src="{{ asset('backend/assets/images/brands/dropbox.png')}}"
                        alt="dropbox"
                    />
                    <span>Dropbox</span>
                    </a>
                ...
                <div class="col">
                    <a class="dropdown-icon-item" href="#">
                    <img
                        src="{{ asset('backend/assets/images/brands/g-suite.png')}}"
                        alt="G Suite"
                    />
                    <span>G Suite</span>
                    </a>
